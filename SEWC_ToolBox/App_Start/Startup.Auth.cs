...
namespace SEWC_ToolBox
{
    public partial class Startup
    {
        ...
        {
            var authority = ConfigurationManager.AppSettings["Authority"].ToString();
        ...
        public void ConfigureAuth1(IAppBuilder app)
        {
            ...
            //factory.Services
            //    .Configure<ConfidentialClientApplicationOptions>(options => { options.RedirectUri = "http://localhost:58735"; })
            //    .AddMicrosoftGraph()
